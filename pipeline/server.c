...
void tty_server_request(int operation, int sync, const char* prompt, char *string){
    ...
    // Add the request to the queue, maintening the first and last pointers
...
/*
 * Client routine -- multiple copies request server
 */
